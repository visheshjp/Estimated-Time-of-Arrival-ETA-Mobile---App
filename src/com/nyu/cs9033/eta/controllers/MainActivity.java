...
public class MainActivity extends Activity implements AsyncResponse
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		try
		{
			...
			final AlertDialog.Builder alertBuilder_about = new AlertDialog.Builder(this);
			...
			aboutUS.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					alertBuilder_about.setTitle("About US");
					alertBuilder_about.setMessage("Trip management is is a basic Application created by Vishesh J. Pathak" +"\n"+"\n"+
							"This app allows friends to keep track of their travelling buddies when planning a trip" +"\n"+"\n"+
							"This feature for now will allow creation of Trips by friends and viewing the latest trip which is created")
							.setCancelable(false)
							...
							// create alert dialog
							AlertDialog alertDialog = alertBuilder_about.create();
